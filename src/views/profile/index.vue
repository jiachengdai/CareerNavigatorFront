          ...
          <div class="talent-profile-container">
            ...
            <div class="talent-chart-section">
              ...
              <div class="radar-chart-container">
                <div class="radar-chart-labels">
                  <div v-for="(value, key) in talentProfile.personalityTraits" :key="key" class="trait-item">
                  ...
                  <div v-if="!hasPersonalityValues" class="trait-empty-hint">
                    <a-alert message="暂无性格特质数据，数据将在提交简历后生成" type="info" showIcon />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div v-if="hasTrends" class="talent-trends-section">
              ...
              <div class="trends-container">
                <div v-for="(value, key) in talentProfile.industryTrends" :key="key" class="trend-item">
            ...
            <div class="talent-market-section">
              ...
              <div class="market-container">
                <div v-for="(value, key) in talentProfile.marketValue" :key="key" class="market-item">
            ...
            <!-- 发展建议 -->
            <div v-if="talentProfile.developmentSuggestions && talentProfile.developmentSuggestions.length > 0" class="talent-suggestions-section">
              <h3>发展建议</h3>
              <a-list 
              ...
              >
                <template #renderItem="{ item }">
                  <a-list-item>
                    <a-tag color="blue">建议</a-tag> {{ item }}
                  </a-list-item>
                </template>
              </a-list>
            </div>
            ...
            <div class="talent-salary-section">
              ...
              <div class="salary-container">
                <div v-for="(value, key) in talentProfile.salaryExpectation" :key="key" class="salary-item">
                  <span class="salary-label">{{ key }}</span>
                  <span class="salary-value">{{ value > 0 ? `${value.toLocaleString()}元/月` : '尚未评估' }}</span>
                </div>
              </div>
            </div>

            <!-- 关键词 -->
            <div v-if="talentProfile.keywords && talentProfile.keywords.length > 0" class="talent-keywords-section">
              <h3>个人标签</h3>
...
const hasTrends = computed(() => {
  ...
  return Object.values(talentProfile.value.industryTrends).some(value => value !== 'NaN');
});
  ...
  try {
    ...
    if (error && typeof error === 'object') {
      ...
      if ('data' in error && error.data && typeof error.data === 'object') {
        if ('personalInfo' in error.data || 'summary' in error.data || 'personalityTraits' in error.data) {
      ...
      if ('response' in error && error.response && typeof error.response === 'object') {
        ...
        if ('data' in error.response && error.response.data && typeof error.response.data === 'object') {
          if ('personalInfo' in error.response.data || 
...
const hasPersonalityValues = computed(() => {
  ...
  // 检查是否至少有一个值不为0
  return Object.values(talentProfile.value.personalityTraits!).some(value => 
