<template>
  <header class="navbar">
    <nav>
      <ul>
        <li>
          <router-link to="/resumeDesign">
            <SvgIcon iconName="resume" /> 简历助手
          </router-link>
        </li>
        ...
        <template #overlay>
          <a-menu>
            <a-menu-item key="profile">
              <a @click="handleViewProfile"> <UserOutlined /> 个人信息 </a>
            </a-menu-item>
            <a-menu-item key="username">
              <a @click="handleUpdateUsername"> <UserOutlined /> 修改用户名 </a>
            </a-menu-item>
            <a-menu-item key="password">
              <a @click="handleChangePassword"> <LockOutlined /> 修改密码 </a>
            </a-menu-item>
            <a-menu-divider />
            <a-menu-item key="logout">
              <a @click="handleLogout"> <LogoutOutlined /> 退出登录 </a>
            </a-menu-item>
          </a-menu>
        </template>
      </a-dropdown>
